...
private slots:
  ...
  void testCoordAnsShipSetting() {
    ...
    QVERIFY(!pl.setCoordinateState(Battleship::Coordinate(2, 1),
  ...
  void testCoordGetting() {
    ...
    QCOMPARE(pl.getPlayerMap().getTile({0, 0}),
    ...
    QCOMPARE(pl.getPlayerMap().getTile({2, 1}),
             Battleship::TileState::Empty | Battleship::TileState::ShipAfloat |
                 Battleship::TileState::WasShot);
    QCOMPARE(pl.getPlayerMap().getTile({9, 9}),
             Battleship::TileState::Empty | Battleship::TileState::ShipAfloat |
                 Battleship::TileState::WasShot |
                 Battleship::TileState::ShipSunk);
  }
